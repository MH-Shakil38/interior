                ...
                <div class="row project-item-boxes align-items-center">
                        ...
                        <div class="project-item wow fadeInUp">
                            <div class="project-image">
                                ...
                                <div class="project-btn">
                                    <a href="{{ asset('/') }}project-single.html"><img
                            ...
                            <div class="project-content">
                                ...
                                <h2><a href="{{ asset('/') }}project-single.html">urban retreat: modern design meets
                                        comfort</a></h2>
                            </div>
                        </div>
                        <!-- Project Item End -->
                    ...
                    <div class="col-md-6 project-item-box interior kitchen">
                        ...
                        <div class="project-item wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <div class="project-content">
                                <h3>luxury homes</h3>
                                <h2><a href="{{ asset('/') }}project-single.html">luxurious loft: industrial chic
                                        for living</a></h2>
                            </div>
                        </div>
                        <!-- Project Item End -->
                    ...
                    <div class="col-md-6 project-item-box furniture architecture">
                        ...
                        <div class="project-item wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <div class="project-content">
                                ...
                                <h2><a href="{{ asset('/') }}project-single.html">coastal vibes: serenity by the
                                        sea</a></h2>
                            </div>
                        </div>
                        <!-- Project Item End -->
                    ...
                    <div class="col-md-6 project-item-box kitchen bedroom">
                        ...
                        <div class="project-item wow fadeInUp" data-wow-delay="0.6s">
                            ...
                            <div class="project-content">
                                ...
                                <h2><a href="{{ asset('/') }}project-single.html">minimalist haven: simple, clean,
                                        inviting spaces</a></h2>
                            </div>
                        </div>
                        <!-- Project Item End -->
                    </div>
