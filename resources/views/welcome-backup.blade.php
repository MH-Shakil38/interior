...
<!-- Mirrored from demo.awaikenthemes.com/html-preview/inspaire/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Feb 2025 18:59:08 GMT -->
<head>
	<!-- Meta -->
	<meta charset="utf-8">
    ...
    <link href="{{asset('/')}}https://fonts.googleapis.com/css2?family=Hanken+Grotesk:ital,wght@0,100..900;1,100..900&amp;display=swap" rel="stylesheet">
	<!-- Bootstrap Css -->
			...
			<nav class="container">
				<div class="navbar navbar-expand-lg">
					...
					<a class="navbar-brand" href="{{asset('/')}}">
						<img src="{{ asset('logo.png') }}" height="60px" alt="Logo">
					</a>
					<!-- Logo End -->
					...
					<div class="collapse navbar-collapse main-menu">
                        <div class="nav-menu-wrapper">
                            <ul class="navbar-nav mr-auto" id="menu">
                                <li class="nav-item submenu"><a class="nav-link" href="{{asset('/')}}index-2.html">Home</a>
                                    <ul>
                ...
                <div class="col-lg-10">
                    ...
                    <div class="hero-content">
                        ...
                        <div class="hero-btn wow fadeInUp" data-wow-delay="0.4s">
                            <a href="{{asset('/')}}about.html" class="btn-default">explore more</a>
                            <a href="{{asset('/')}}projects.html" class="btn-default btn-highlighted">view projects</a>
                        </div>
                        <!-- Hero Button End -->
                    </div>
                    <!-- Hero Content End -->
                        ...
                        <div class="about-us-content-body">
                            ...
                            <div class="about-us-content-info">
                                ...
                                <div class="about-us-content-btn wow fadeInUp" data-wow-delay="0.6s">
                                    <a href="{{asset('/')}}about.html" class="btn-default">read more</a>
                                </div>
                    ...
                    <div class="why-choose-content">
                        ...
                        <div class="why-choose-item-list">
                            ...
                            <div class="why-choose-item wow fadeInUp" data-wow-delay="0.6s">
                                <!-- Icon Box Start -->
                                <div class="icon-box">
                                    <img src="{{asset('/')}}images/icon-why-choose-2.svg" alt="">
                                </div>
                                <!-- Icon Box End -->
                            ...
                            <div class="why-choose-item wow fadeInUp" data-wow-delay="0.8s">
                                <!-- Icon Box Start -->
                                <div class="icon-box">
                                    <img src="{{asset('/')}}images/icon-why-choose-3.svg" alt="">
                                </div>
                                <!-- Icon Box End -->
                    ...
                    <div class="why-choose-images">
                        ...
                        <div class="why-choose-img-box-2">
                            ...
                            <div class="why-choose-img-3">
                                <figure class="image-anime reveal">
                                    <img src="{{asset('/')}}images/why-choose-img-3.jpg" alt="">
                                </figure>
                            </div>
                            ...
                            <div class="why-choose-img-4">
                                <figure class="image-anime reveal">
                                    <img src="{{asset('/')}}images/why-choose-img-4.jpg" alt="">
                                </figure>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp">
                        ...
                        <div class="service-image">
                            <a href="{{asset('/')}}service-single.html" data-cursor-text="View">
                                <figure class="image-anime">
                        ...
                        <div class="service-btn">
                            <a href="{{asset('/')}}service-single.html"><img src="{{asset('/')}}images/arrow-white.svg" alt=""></a>
                        </div>
                        <!-- Service Button End -->

                        <!-- Service Content Start -->
                        <div class="service-content">
                            <h3><a href="{{asset('/')}}service-single.html">residential interior design</a></h3>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <!-- Service Content Start -->
                        <div class="service-content">
                            <h3><a href="{{asset('/')}}service-single.html">commercial interior design</a></h3>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <!-- Service Content Start -->
                        <div class="service-content">
                            <h3><a href="{{asset('/')}}service-single.html">furniture and decor selection</a></h3>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="all-services-btn wow fadeInUp" data-wow-delay="0.6s">
                        <a href="{{asset('/')}}services.html" class="btn-default">see all services</a>
                   </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="intro-video-box">
                        ...
                        <div class="intro-video-image">
                            <a href="{{asset('/')}}https://www.youtube.com/watch?v=Y-x0efG1seA" class="popup-video" data-cursor-text="Play">
                                <figure class="image-anime">
                                    <img src="{{asset('/')}}images/intro-video-bg.jpg" alt="">
                                </figure>
                            </a>
                        </div>
                        <!-- Intro Image End -->
                        ...
                        <div class="video-play-button">
                            <a href="{{asset('/')}}https://www.youtube.com/watch?v=Y-x0efG1seA" class="popup-video" data-cursor-text="Play">play</a>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="our-Project-nav wow fadeInUp" data-wow-delay="0.4s">
                        <ul>
                            <li><a href="{{asset('/')}}#" class="active-btn" data-filter="*">all</a></li>
                            <li><a href="{{asset('/')}}#" data-filter=".architecture">architecture</a></li>
                            <li><a href="{{asset('/')}}#" data-filter=".interior">interior</a></li>
                            <li><a href="{{asset('/')}}#" data-filter=".bedroom">bedroom</a></li>
                            <li><a href="{{asset('/')}}#" data-filter=".furniture">furniture</a></li>
                            <li><a href="{{asset('/')}}#" data-filter=".kitchen">kitchen</a></li>
                        </ul>
                    </div>
                    <!-- Our Project Nav End -->
                </div>
                    ...
                    <div class="row project-item-boxes align-items-center">
                            ...
                            <div class="project-item wow fadeInUp">
                                <div class="project-image">
                                    ...
                                    <div class="project-btn">
                                        <a href="{{asset('/')}}project-single.html"><img src="{{asset('/')}}images/arrow-white.svg" alt=""></a>
                                    </div>
                                </div>

                                <div class="project-content">
                                    <h3>residential spaces</h3>
                                    <h2><a href="{{asset('/')}}project-single.html">urban retreat: modern design meets comfort</a></h2>
                                </div>
                            </div>
                            <!-- Project Item End -->
                        </div>
                        ...
                        <div class="col-md-6 project-item-box interior kitchen">
                            ...
                            <div class="project-item wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <div class="project-content">
                                    <h3>luxury homes</h3>
                                    <h2><a href="{{asset('/')}}project-single.html">luxurious loft: industrial chic for living</a></h2>
                                </div>
                            </div>
                            <!-- Project Item End -->
                        </div>
                        ...
                        <div class="col-md-6 project-item-box furniture architecture">
                            ...
                            <div class="project-item wow fadeInUp" data-wow-delay="0.4s">
                                ...
                                <div class="project-content">
                                    ...
                                    <h2><a href="{{asset('/')}}project-single.html">coastal vibes: serenity by the sea</a></h2>
                                </div>
                            </div>
                            <!-- Project Item End -->
                        </div>
                        ...
                        <div class="col-md-6 project-item-box kitchen bedroom">
                            ...
                            <div class="project-item wow fadeInUp" data-wow-delay="0.6s">
                                ...
                                <div class="project-content">
                                    ...
                                    <h2><a href="{{asset('/')}}project-single.html">minimalist haven: simple, clean, inviting spaces</a></h2>
                                </div>
                            </div>
                            <!-- Project Item End -->
                        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="how-we-work-list">
                        ...
                        <div class="how-we-work-item wow fadeInUp">
                            <div class="icon-box">
                                <img src="{{asset('/')}}images/icon-how-we-work-1.svg" alt="">
                            </div>
                        ...
                        <div class="how-we-work-item wow fadeInUp" data-wow-delay="0.2s">
                            <div class="icon-box">
                                <img src="{{asset('/')}}images/icon-how-we-work-2.svg" alt="">
                            </div>
                            <div class="how-we-work-content">
                        ...
                        <div class="how-we-work-item wow fadeInUp" data-wow-delay="0.4s">
                            <div class="icon-box">
                                <img src="{{asset('/')}}images/icon-how-we-work-3.svg" alt="">
                            </div>
                            <div class="how-we-work-content">
                        ...
                        <div class="how-we-work-item wow fadeInUp" data-wow-delay="0.6s">
                            <div class="icon-box">
                                <img src="{{asset('/')}}images/icon-how-we-work-4.svg" alt="">
                            </div>
                            <div class="how-we-work-content">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="our-skill-image">
                        <div class="our-skill-img-1">
                            <figure class="image-anime reveal">
                                <img src="{{asset('/')}}images/our-skill-img-1.jpg" alt="">
                            </figure>
                        </div>

                        <div class="our-skill-img-2">
                            <figure class="image-anime reveal">
                                <img src="{{asset('/')}}images/our-skill-img-2.jpg" alt="">
                            </figure>
                        </div>

                        <div class="our-skill-img-3">
                            <figure class="image-anime reveal">
                                <img src="{{asset('/')}}images/our-skill-img-3.jpg" alt="">
                            </figure>
                        </div>
                    </div>
                    <!-- Our Skill Image End -->
            ...
            <div class="row no-gutters">
                <div class="col-lg-6">
                    ...
                    <div class="our-testimonials-image">
                        <figure class="image-anime">
                            <img src="{{asset('/')}}images/testimonial-img.jpg" alt="">
                        </figure>
                    </div>
            ...
            <div class="row section-row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-2" data-cursor="-opaque"><span>Your guide to</span> geotech interiors</h2>
                    </div>
                    <!-- Section Title End -->
                </div>
                ...
                <div class="col-lg-6">
                    <!-- Section Title Content Start -->
                    <div class="section-title-content">
                        <p class="wow fadeInUp" data-wow-delay="0.2s">Your journey to geotech interiors begins here. Our blog offers a wealth of resources, including design tips, trend analyses.</p>
                    </div>
                    <!-- Section Title Content End -->
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="post-item wow fadeInUp">
                        ...
                        <div class="post-featured-image">
                            <figure>
                                <a href="{{asset('/')}}blog-single.html" class="image-anime" data-cursor-text="View">
                        ...
                        <div class="post-item-body">
                            ...
                            <div class="post-item-content">
                                <h3><a href="{{asset('/')}}blog-single.html">How Does One Go About a Buying Furniture?</a></h3>
                            </div>
                            <!-- Post Item Content End -->

                            <!-- Blog Item Button Start -->
                            <div class="post-item-btn">
                                <a href="{{asset('/')}}blog-single.html" class="post-btn">read more</a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="post-item wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="post-item-body">
                            <!-- Post Item Content Start -->
                            <div class="post-item-content">
                                <h3><a href="{{asset('/')}}blog-single.html">Innovative Décor Ideas Shaping Homes Today</a></h3>
                            </div>
                            <!-- Post Item Content End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="post-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="post-item-body">
                            <!-- Post Item Content Start -->
                            <div class="post-item-content">
                                <h3><a href="{{asset('/')}}blog-single.html">Design Industry Updates You Should Know About</a></h3>
                            </div>
                            <!-- Post Item Content End -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="our-blog-footer wow fadeInUp" data-wow-delay="0.6s">
                        <a href="{{asset('/')}}blog.html" class="btn-default">See All Blogs</a>
                    </div>
                    <!-- Our Blog Footer End -->
                </div>
            </div>
...
<!-- Mirrored from demo.awaikenthemes.com/html-preview/inspaire/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Feb 2025 18:59:26 GMT -->
</html>
